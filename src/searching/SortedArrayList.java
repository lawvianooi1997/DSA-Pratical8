...
//  } // end binarySearch
    ...
    private int binarySearch(int first, int last, T desiredItem){
        ...
        while(first <= last){ //to make sure the array has something
        ...
        return -1; //if item cabbit be found in the array.
    }
  ...
  public int getPosition(T anEntry) {
      ...
      int index = binarySearch(0,length-1, anEntry); //(first , last, desired)
